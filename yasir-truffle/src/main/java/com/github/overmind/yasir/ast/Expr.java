...
public abstract class Expr extends Node {
    ...
    public BareFunction executeBareFunction(VirtualFrame frame) throws UnexpectedResultException {
        return YasirTypesGen.expectBareFunction(executeGeneric(frame));
    }
