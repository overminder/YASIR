...
@NodeChildren({@NodeChild("matFrame"), @NodeChild("value")})
public abstract class WriteNonlocalNode extends Expr {
     ...
     * {@link #isLongKind(MaterializedFrame) custom guard} is specified.
     */
    @Specialization(guards = "isLongKind(frame)")
    protected MaterializedFrame writeLong(MaterializedFrame frame, long value) {
        frame.setLong(getSlot(), value);
        return frame;
    }

    @Specialization(guards = "isBooleanKind(frame)")
    protected MaterializedFrame writeBoolean(MaterializedFrame frame, boolean value) {
    ...
    protected MaterializedFrame write(MaterializedFrame frame, Object value) {
    ...
    protected boolean isLongKind(MaterializedFrame frame) {
        return isKind(FrameSlotKind.Long);
    }

    @SuppressWarnings("unused")
    protected boolean isBooleanKind(MaterializedFrame frame) {
